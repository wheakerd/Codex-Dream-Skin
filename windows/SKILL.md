...
1. Install Node.js 22 or newer, close Codex, then run `scripts/install-dream-skin.ps1` once to preserve the user's native appearance settings, seed the Romantic Rose theme, and create launch/restore/tray shortcuts.
...
- `assets/dream-reference.jpg`: pure 2560 × 1440 Romantic Rose wallpaper seeded as the default and as a saved theme; it contains no Codex UI.
